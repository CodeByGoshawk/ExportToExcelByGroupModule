...
public partial class WorkDataBase1Context : DbContext
{
    public WorkDataBase1Context()
    {
    }

    public WorkDataBase1Context(DbContextOptions<WorkDataBase1Context> options)
        : base(options)
    {
    }
    private string connectionString = ConfigurationManager.ConnectionStrings["ESP-WorkDataBase1"].ConnectionString;
